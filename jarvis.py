...
def  wishMe():
    ...
    speak(" this is your desktop assistant title queen  and  i am  created by Apoorv mishra,Sourabh and Agnim IN THE GUIDENCE OF LAL SINGH SIR,  how can i help you")
...
if __name__ == "__main__":
    ...
    #logic for query which jarvis will give as output
        if 'wikipedia' in query :
            ...
            print("i am your desktop asistant sir.. and my name is  little queen sir..and my creation done by apoorv mishra  sourabh  baghel and agnim seth.") 
            speak("i am your desktop asistant sir.. and my name is  little queen sir..and my creation done by apoorv mishra  sourabh  baghel and agnim seth.")
